...
if __name__ == "__main__":
    ...
    cfg_dict = {
        ...
        "neural_recording_sparsity": 1., # sparsity of 1. means all neurons are recorded
        "measurement_noise_scale": 0.,  # scale of gaussian noise added to neural recordings would be measurement_noise * firing_rate
        ...
        "plasticity_model": "mlp",  # "volterra" or "mlp
